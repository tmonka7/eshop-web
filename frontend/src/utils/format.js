...
/**
 * Order statuses arrive as snake_case enum values and the catalogue has a
 * translation for each. An unknown value falls back to a title-cased version,
 * so a status added server-side still reads sensibly.
 */
